...
function App() {
  ...
  return (
    <div className="min-w-full min-h-screen flex items-center justify-center bg-opacity-70 fixed top-0 left-0 z-50">
      {/* Left Section for the Image */}
      <div
        className="w-full sm:w-1/2 min-h-screen relative group overflow-hidden"
        style={{
      ...
      <div className="relative w-full sm:w-1/2 min-h-screen flex items-center justify-center bg-cover bg-left" style={{ backgroundImage: 'url(https://img.freepik.com/premium-vector/circuit-technology-background-with-hitech-digital-data-connection-system-computer-electronic-design_29971-1092.jpg?w=1380)' }}>
